##----------------------------------------------------------------------------##
## Lockpicking Script v1.2.1
## Created by Neon Black
## Modded by Roninator2 - correcting a bug and adding broken locks
...
##----------------------------------------------------------------------------##
##    Revision Info:
## V1.2.1 - 30.4.2020 Fixed bug and added message for broken lock
## V1.2 - 29.4.2020 Added durability for locks and fixed bug for locks
## v1.1 - 3.3.2013
...
class Lockpick < Scene_MenuBase
  ...
  def lock_broke
    ...
    $game_message.add(CP::LOCKPICK::SETTINGS::BROKEN) if @door == -1
    picking_end
  end

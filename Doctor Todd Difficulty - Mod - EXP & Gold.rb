...
HARDM = 1.5    
#Easy enemy experience multiplier.  
EASYEXPM = 0.75   
...
#--------------------------------------------------------------------------  
	...
	def exp    
		...
		when 0 
			enemy.exp * TODDDIFFICULTY::EASYEXPM    
		when 1 
			enemy.exp           
		when 2 
	...
	def gold    
		case $game_system.todd_difficulty    
		when 0 
			enemy.gold * TODDDIFFICULTY::EASYGOLDM    
		when 1 
			enemy.gold    
		when 2 
	...
	def make_drop_items    
		case $game_system.todd_difficulty    
			when 0 
				@DropMulti = TODDDIFFICULTY::EASYDROPM    
			when 1 
				@DropMulti = 1    
			when 2 

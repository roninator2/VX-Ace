# ╔═══════════════════════════════════════════════╦════════════════════╗
# ║ Title: Party Swap for all Vehicles            ║  Version: 1.01     ║
# ║ Author: Roninator2                            ║                    ║
# ╠═══════════════════════════════════════════════╬════════════════════╣
# ║ Function:                                     ║   Date Created     ║
# ║   Save the party in order to swap             ╠════════════════════╣
# ║   for a vehicle for the party                 ║    22 Jul 2023     ║
# ╚═══════════════════════════════════════════════╩════════════════════╝
# ╔════════════════════════════════════════════════════════════════════╗
# ║ Requires:                                                          ║
...
# ╔════════════════════════════════════════════════════════════════════╗
# ║ Updates:                                                           ║
# ║ 1.00 - 22 Jul 2022 - Script finished                               ║
# ║                                                                    ║
# ╚════════════════════════════════════════════════════════════════════╝
# ╔════════════════════════════════════════════════════════════════════╗
# ║ Credits and Thanks:                                                ║
...
module R2_LAND_VEHICLE
  LAND_ACTOR = 11       # Actor that is used as the land vehicle
...
module BattleManager
  ...
  #--------------------------------------------------------------------------
  def self.gain_exp
    if $game_player.in_boat? || $game_player.in_ship? || $game_player.in_airship? || $game_player.in_land?
...
class Game_Player < Game_Character
  ...
  def update_vehicle_get_on
    if !@followers.gathering? && !moving?
      ...
      case @vehicle_type
      when :land ; $game_party.add_actor(R2_LAND_VEHICLE::LAND_ACTOR)
  ...
  def get_off_vehicle
    if vehicle.land_ok?(@x, @y, @direction)
      ...
      case @vehicle_type
      when :land ; $game_party.remove_actor(R2_LAND_VEHICLE::LAND_ACTOR)
